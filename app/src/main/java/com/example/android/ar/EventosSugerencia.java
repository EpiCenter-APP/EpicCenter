...
public class EventosSugerencia extends ListFragment {

    Vector<ComponenteEvento> eventos = new Vector<ComponenteEvento>();

    public EventosSugerencia() {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setListAdapter(new AdaptadorEventos(getActivity(), eventos));
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        view = (LinearLayout) inflater.inflate(R.layout.eventos_sugerencias, container, false);

        //return inflater.inflate(R.layout.eventos_sugerencias, container, false);
